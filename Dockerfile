# Docker image for mongodb using the almalinux template
ARG IMAGE_NAME="mongodb"
ARG PHP_SERVER="mongodb"
ARG BUILD_DATE="Wed Aug 23 12:08:34 AM EDT 2023"
ARG LANGUAGE="en_US.UTF-8"
ARG TIMEZONE="America/New_York"
ARG WWW_ROOT_DIR="/usr/share/webapps/mongodb"
...
ENV HOSTNAME="casjaysdev-mongodb"
...
RUN set -ex; \
  git clone --depth 1 "https://github.com/mongo-express/mongo-express" "${WWW_ROOT_DIR}}" || exit 2; \
  cd "${WWW_ROOT_DIR}}" && yarn install && npm run build || exit 10; \
  cp -Rf "/usr/local/share/template-files/config/mongo-express/config.js" "${WWW_ROOT_DIR}}" || exit 10; \
  echo ""
...
LABEL org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/mongodb"
LABEL org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/mongodb"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.vcs-ref="${BUILD_VERSION}"
LABEL org.opencontainers.image.vcs-url="https://hub.docker.com/r/casjaysdevdocker/mongodb"
LABEL org.opencontainers.image.documentation="https://hub.docker.com/r/casjaysdevdocker/mongodb"
