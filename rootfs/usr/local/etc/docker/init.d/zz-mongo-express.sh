...
RUN_DIR="/run/init.d"
# set log directory
LOG_DIR="/data/logs/mongo-express"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
...
# root user name
root_user_name="${SERVICE_SAMPLE_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${SERVICE_SAMPLE_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${SERVICE_SAMPLE_USER_NAME:-}"
# normal user password
user_pass="${SERVICE_SAMPLE_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
