...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set webroot
WWW_DIR="/usr/share/webapps/mongodb"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# root user name
root_user_name="${MONGODB_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${MONGODB_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${MONGODB_USER_NAME:-}"
# normal user password
user_pass="${MONGODB_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  if [ "$IS_WEB_SERVER" = "yes" ]; then
    ...
    if __is_dir_empty "$WWW_DIR" || [ ! -d "$WWW_DIR" ]; then
  ...
  # replace variables
  # __replace "" "" "$ETC_DIR/mongodb.conf"
